...
from .views import DatasetDetailView, DatasetFileUpdateView, DatasetListView, DatasetUploadView
...
urlpatterns = [
    ...
    path("<uuid:dataset_id>/file/", DatasetFileUpdateView.as_view(), name="dataset-file-update"),
]
